"""
LaTeX Generator - ERWEITERT mit Klassensatz-Generierung
========================================================
...
class LaTeXGenerator:
    """LaTeX Generator mit API-Integration und Klassensatz-Support"""
    ...
    def generate_klassensatz(
        ...
        Args:
            ...
            progress_callback: Callback für Progress (value, message)
        ...
        try:
            ...
            if progress_callback:
                progress_callback(50, "Kompiliere PDF mit API...")
            ...
            if progress_callback:
                progress_callback(70, "Sortiere Seiten um...")
...
"""
        ...
        for idx, schueler in enumerate(schueler_list, start=1):
            ...
            # Running Header
            running_header = f"{klausur.nummer}. {klausur.typ} in der {klausur.klasse} von {schueler_name} ({idx})"
            ...
            for aufgabe in aufgaben:
                ...
                # Seitenumbruch?
                # TODO: Aus klausur.page_breaks auslesen
    ...
    def _sortiere_pdf_seiten(
        ...
        """Sortiert PDF-Seiten: 1-2-3-4 → 4-1-2-3"""
        ...
        try:
            ...
            if total_pages % pages_per_student != 0:
                print(f"Warnung: Seitenzahl ({total_pages}) ist kein Vielfaches von {pages_per_student}")
    ...
    # ========================================================================
    # BESTEHENDE METHODEN (Aufgaben-Preview etc.)
    # ========================================================================
    
    def generate_aufgabe_preview_png(
        self,
        aufgabe: Dict,
        mit_loesung: bool = False,
        dpi: int = 150,
        aufgabe_id: Optional[int] = None
    ) -> Optional[bytes]:
        """
        Generiert PNG-Vorschau einer Aufgabe via API
